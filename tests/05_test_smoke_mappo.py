"""Tiny MAPPO smoke run: 2 envs x 32 rollout x 2 updates x 1 epoch.

    python tests/05_test_smoke_mappo.py
"""
...
def main() -> None:
    ...
    ap.add_argument("--out", type=Path, default=RUNS_ROOT / "tests/smoke_mappo")
    args = ap.parse_args()
