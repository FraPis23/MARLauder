"""Frontier detection on top of probabilistic occupancy.
...
border UNKNOWN. Walls are dark navy and visually distinct.
    ...
    python tests/03_test_frontier.py
"""
...
def main() -> None:
    ...
    ap.add_argument("--out", type=Path, default=RUNS_ROOT / "tests/frontier.png")
    args = ap.parse_args()
