"""Warp LiDAR + probabilistic occupancy on a real map.
...
NOT red here.
    ...
    python tests/02_test_lidar.py --split train/easy --map-idx 0
"""
...
def main() -> None:
    ...
    ap.add_argument("--out", type=Path, default=RUNS_ROOT / "tests/occupancy.png")
    args = ap.parse_args()
