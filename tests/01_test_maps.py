"""Map loader: load a split and save a 2x2 mosaic with start markers.

Run inside container:
    python tests/01_test_maps.py --split train/easy
"""
...
def main() -> None:
    ...
    ap.add_argument("--out", type=Path, default=RUNS_ROOT / "tests/maps.png")
    args = ap.parse_args()
